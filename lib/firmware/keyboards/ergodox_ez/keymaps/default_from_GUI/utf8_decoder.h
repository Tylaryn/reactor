...
#define UTF8_INCORRECT 0
#define U8_BAD UTF8_INCORRECT

#define UTF8_STATE_OK 0
#define U8_S_OK UTF8_STATE_OK
#define UTF8_STATE_MISSING_EXPECTED_CONTINUATION_BYTE -1
#define U8_S_MECB UTF8_STATE_MISSING_EXPECTED_CONTINUATION_BYTE
#define UTF8_STATE_UNEXPECTED_CONTINUATION_BYTE -2
#define U8_S_UNCB UTF8_STATE_UNEXPECTED_CONTINUATION_BYTE
#define UTF8_STATE_ILLEGAL_AMOUNT_OF_ENCODING_BYTES -3
#define U8_S_IAEB UTF8_STATE_ILLEGAL_AMOUNT_OF_ENCODING_BYTES
#define UTF8_STATE_OVERLONG_ENCODING -4
#define U8_S_OVEC UTF8_STATE_OVERLONG_ENCODING
#define UTF8_STATE_CODEPOINT_TOO_BIG -5
#define U8_S_CPTB UNICODE_CODEPOINT_TOO_BIG
#define UTF8_STATE_CODEPOINT_ILLEGAL_RANGE -6
#define U8_S_CPIR UTF8_STATE_CODEPOINT_ILLEGAL_RANGE
#define UTF8_STATE_UNEXPECTED_END_OF_STRING -7
#define U8_S_UEOS UTF8_STATE_UNEXPECTED_END_OF_STRING
...
typedef struct  {
  ...
  int8_t status;
  const char* str;
} utf8_decoder_struct_t;

typedef utf8_decoder_struct_t* utf8_decoder_t;
